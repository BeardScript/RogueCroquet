...
export declare const initComponents: (scene: Scene, componentsToLoad?: Object) => void;
...
export declare function getComponentByName(name: string, object3d?: Object3D, inAncestor?: boolean): any;
export declare const getComponent: <T extends Component>(ComponentClass: new (...args: any[]) => T, object3d?: Object3D, inAncestor?: boolean) => T;
